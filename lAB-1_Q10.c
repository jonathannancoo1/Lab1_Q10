...
void app_main(void)
{
    ...
    const int Priority_task_2=1; //Task two priority
    const int Priority_task_3=1; //Task two priority
    ...
    if (g_Mutex != NULL)
    {
        ...
        xTaskCreate(Task2, "Task 2", BUF_SIZE_2, NULL, Priority_task_1, NULL);
        xTaskCreate(Task3, "Task 3", BUF_SIZE_2, NULL, Priority_task_1, NULL);
    }
}